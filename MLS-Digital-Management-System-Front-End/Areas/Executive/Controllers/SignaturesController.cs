...
namespace MLS_Digital_Management_System_Front_End.Areas.Executive.Controllers
{
    ...
    public class SignaturesController : Controller
    {
        ...
        public SignaturesController(IServiceRepository serviceRepository)
        {
        ...
        public async Task<IActionResult> SignatureDetails(int Id)
        {
            await PopulateViewBags();
            var signature = await _service.SignatureService.GetSignatureByIdAsync(Id);
